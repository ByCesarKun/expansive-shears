...
const tools = [
    'multimc:amethyst_shears',
    'multimc:cobblestone_shears',
    'multimc:copper_shears',
    'multimc:diamond_shears',
    'multimc:emerald_shears',
    'multimc:golden_shears',
    'multimc:lapis_shears',
    'multimc:netherite_shears',
    'multimc:obsidian_shears',
    'multimc:wooden_shears'
];

// Evento para cuando un jugador rompe un bloque (Durabilidad)
